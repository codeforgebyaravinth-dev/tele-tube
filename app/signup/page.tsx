...
import { Youtube, Mail, Lock, User, ArrowRight, Github } from "lucide-react";
        ...
        <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center px-4 py-12 relative overflow-hidden">
            ...
            >
                <div className="flex flex-col items-center mb-8">
                    ...
                    <p className="text-gray-400 text-sm mt-1">Join the TeleTube community today</p>
                </div>
                ...
                <form className="space-y-6">
                    ...
                    <p className="text-[10px] text-gray-500 leading-relaxed px-1">
                        By signing up, you agree to our <span className="text-gray-300 cursor-pointer hover:underline">Terms of Service</span> and <span className="text-gray-300 cursor-pointer hover:underline">Privacy Policy</span>.
                    </p>
                ...
                <div className="mt-8 flex flex-col gap-4">
                    <div className="relative">
                        ...
                        <div className="relative flex justify-center text-xs uppercase"><span className="bg-[#030303] px-2 text-gray-500 font-bold tracking-widest">Or sign up with</span></div>
                    </div>
                ...
                <p className="mt-8 text-center text-sm text-gray-500">
                    ...
                    <Link href="/login" className="text-purple-400 hover:text-purple-300 font-bold underline decoration-purple-400/30 underline-offset-4">
                        Sign in
                    </Link>
                </p>
            </motion.div>
